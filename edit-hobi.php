...
$id_hobi = $koneksi->real_escape_string($_GET['id_hobi']);
$a = $koneksi -> query("SELECT * FROM hobi WHERE id_hobi = '$id_hobi'");
$data = $a->fetch_assoc();
...
if (isset($_POST['submit'])) {
  ...
  include 'koneksi.php';
  $a = $koneksi->query("UPDATE `hobi` SET `nama`='$nama',`usia`='$usia',`hobi`='$hobi' WHERE id_hobi = '$id_hobi'");
  ?>
  <script>
    Swal.fire({
        icon: 'success',
